 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `KLModel` protocol for custom methods.
 ...
 Sample Code:
     ...
     ********************** json convertor *********************
 @code
     @interface KLAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation KLAuthor
     @end
 
     @interface KLBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) KLAuthor *author;
     @end
     @implementation KLBook
     @end
    
     int main() {
         // create model from json
         KLBook *book = [KLBook kl_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book kl_modelToJSONString];
 ...
 @code
     @interface KLShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation KLShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self kl_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self kl_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self kl_modelCopy]; }
     - (NSUInteger)hash { return [self kl_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self kl_modelIsEqual:object]; }
     @end
 @endcode
 
 */
@interface NSObject (KLModel)
 ...
 */
+ (nullable instancetype)kl_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)kl_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (nullable id)kl_modelToJSONObject;
 ...
 */
- (nullable NSData *)kl_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)kl_modelToJSONString;
 ...
 */
+ (nullable NSArray *)kl_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (KLModel)
 ...
 */
+ (nullable NSDictionary *)kl_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<KLModel>' to your class header.
 */
@protocol KLModel <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
  @code
        @class KLShadow, KLBorder, KLAttachment;
 
        @interface KLAttributes
        @property NSString *name;
        ...
        @implementation KLAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [KLShadow class],
                     @"borders" : KLBorder.class,
                     @"attachments" : @"KLAttachment" };
        }
        @end
  @endcode
...
/**
 ...
 Example:
 @code
        @class KLCircle, KLRectangle, KLLine;
 
        @implementation KLShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [KLCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [KLRectangle class];
