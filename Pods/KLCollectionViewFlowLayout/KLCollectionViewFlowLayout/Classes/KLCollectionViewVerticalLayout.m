//
//  KLCollectionViewVerticalLayout.m
//  KLCollectionView
//
...
@interface KLCollectionViewVerticalLayout ()

@end

@implementation KLCollectionViewVerticalLayout
                            ...
                            if ((totalPercent+percent) >= 1.0) {
                                if ((totalPercent+percent) < 1.1) {
                                    ...
                                    for (NSInteger i=0; i<arrayOfPercent.count; i++) {
                                        ...
                                        KLCollectionViewLayoutAttributes *newAttributes = dic[@"item"];
                                        CGFloat itemX = 0.0f;
                                        if (i==0) {
                                            itemX = edgeInsets.left;
                                        } else {
                                            KLCollectionViewLayoutAttributes *preAttr = arrayOfPercent[i-1][@"item"];
                                    ...
                                    for (NSInteger i=0; i<arrayOfPercent.count; i++) {
                                        NSDictionary* dic = arrayOfPercent[i];
                                        KLCollectionViewLayoutAttributes *item = dic[@"item"];
                                    ...
                                    if (arrayOfPercent.count > 0) {
                                        for (int i=0; i<arrayOfPercent.count; i++) {
                                            NSDictionary* dic = arrayOfPercent[i];
                                            KLCollectionViewLayoutAttributes* attr = dic[@"item"];
                                ...
                                KLCollectionViewLayoutAttributes *lastAttributesForPercent = lastDicForPercent[@"item"];
...
#pragma mark 填充布局处理
                    case FillLayout: {
                        if (arrayOfFill.count == 0) {
                            ...
                            for (KLCollectionViewLayoutAttributes* attr in arrayOfFill) {
