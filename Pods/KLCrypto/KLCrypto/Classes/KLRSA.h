 ...
 *  密钥长度，以比特为单位
 */
FOUNDATION_EXPORT NSUInteger const KLRSAKeySizeInBits2048;
FOUNDATION_EXPORT NSUInteger const KLRSAKeySizeInBits1024;

/**
 *  RSA，加解密时使用kSecPaddingPKCS1，默认生成的密钥的长度为2048位
 */
@interface KLRSA : NSObject
...
- (BOOL)generateKeys;
/**
 根据指定的密钥长度，生成公私钥对。当前只支持KLRSAKeySizeInBits中声明的长度。

 @param keySizeInBits KLRSAKeySizeInBits2048 / KLRSAKeySizeInBits1024
 @return 是否成功生成公私钥对，成功：YES，失败：NO
 */
