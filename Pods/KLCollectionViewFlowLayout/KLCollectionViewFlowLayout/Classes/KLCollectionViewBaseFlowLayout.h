//
//  KLCollectionViewBaseFlowLayout.h
//  KLCollectionView
//
...
@class KLCollectionViewBaseFlowLayout;

@protocol  KLCollectionViewBaseFlowLayoutDelegate <NSObject, UICollectionViewDelegateFlowLayout>
@optional
...
/***
 ...
 纵向布局请调用 #import "KLCollectionViewVerticalLayout.h"
 横向布局请调用 #import "KLCollectionViewHorzontalLayout.h"
 ***/
@interface KLCollectionViewBaseFlowLayout : UICollectionViewFlowLayout

@property (nonatomic,assign) id<KLCollectionViewBaseFlowLayoutDelegate> delegate;
...
@property (nonatomic,assign) KLLayoutType layoutType;
/** 指定列数 */
