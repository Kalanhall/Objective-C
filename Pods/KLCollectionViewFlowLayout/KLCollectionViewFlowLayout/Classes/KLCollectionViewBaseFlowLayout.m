//
//  KLCollectionViewBaseFlowLayout.m
//  KLCollectionView
//
...
@interface KLCollectionViewBaseFlowLayout ()
<UIGestureRecognizerDelegate>

//关于拖动的参数
@property (nonatomic, strong) KLCellFakeView *cellFakeView;
@property (nonatomic, strong) UILongPressGestureRecognizer *longPress;
@property (nonatomic, strong) UIPanGestureRecognizer *panGesture;
@property (nonatomic, assign) CGPoint fakeCellCenter;
@property (nonatomic, assign) CGPoint panTranslation;
@property (nonatomic, assign) LewScrollDirction continuousScrollDirection;
@property (nonatomic, strong) CADisplayLink *displayLink;

@end

@implementation KLCollectionViewBaseFlowLayout
...
+ (Class)layoutAttributesClass {
    return [KLCollectionViewLayoutAttributes class];
}
...
- (void)setUpGestureRecognizers {
    ...
    __weak typeof(KLCollectionViewBaseFlowLayout*) weakSelf = self;
...
- (void)handleLongPress:(UILongPressGestureRecognizer *)longPress {
    ...
    switch (longPress.state) {
        case UIGestureRecognizerStateBegan: {
            ...
            self.cellFakeView = [[KLCellFakeView alloc]initWithCell:currentCell];
...
- (void)moveItemIfNeeded {
    ...
    for (KLCollectionViewLayoutAttributes* attr in self.attributesArray) {
